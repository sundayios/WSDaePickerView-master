...
#define Color_Button_Action RGB(255, 255, 255)
#define Color_Btn_Title_Normar [UIColor blackColor]
#define FontSize_Button 14
// 判断是否是iPhone X
...
-(void)setupUI {
    ...
    self.doneButtonColor = Color_Button_Action;
    self.cancelButtonColor = Color_Button_Action;
    self.doneBtnTitleColor = Color_Btn_Title_Normar;
    self.cancelBtnTitleColor = Color_Btn_Title_Normar;
    self.btnTitleFontSize = FontSize_Button;
...
- (void)setCancelButtonColor:(UIColor *)cancelButtonColor{
    ...
    self.cancelButton.backgroundColor = cancelButtonColor;
}
- (void)setDoneBtnTitleColor:(UIColor *)doneBtnTitleColor{
    _doneBtnTitleColor = doneBtnTitleColor;
    [self.doneBtn setTitleColor:doneBtnTitleColor forState:UIControlStateNormal];
}
...
- (void)setBtnTitleFontSize:(NSInteger)btnTitleFontSize{
    self.doneBtn.titleLabel.font = [UIFont systemFontOfSize:btnTitleFontSize];
    self.cancelButton.titleLabel.font = [UIFont systemFontOfSize:btnTitleFontSize];
}
